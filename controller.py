...
class Controller:
    ...
    def detect_exit_gesture():
        exit_condition = (
            Controller.middle_finger_within_Thumb_finger and Controller.ring_finger_within_Thumb_finger and
            Controller.little_finger_up and 
            Controller.index_finger_up and
            not Controller.little_finger_within_Thumb_finger and not Controller.index_finger_within_Thumb_finger     
        )
    ...
    def detect_minimize():
        minimize_condition = (
            Controller.little_finger_within_Thumb_finger and
            Controller.index_finger_up and
            Controller.middle_finger_up and
            Controller.ring_finger_up and not Controller.index_finger_within_Thumb_finger and 
            not Controller.middle_finger_within_Thumb_finger and not Controller.ring_finger_within_Thumb_finger
        )
        if minimize_condition:
    ...
    def detect_maximize():
        maximize_condition = (
            ...
            Controller.Thump_finger_up
        )
        if maximize_condition:
            pyautogui.hotkey('win', 'up')

    @staticmethod
    def detect_close():
        close_condition = (
            Controller.index_finger_within_Thumb_finger and Controller.middle_finger_within_Thumb_finger and
            Controller.little_finger_up and Controller.ring_finger_up and not 
            Controller.ring_finger_within_Thumb_finger and not Controller.little_finger_within_Thumb_finger
        )
        if close_condition:
